...
# Form implementation generated from reading ui file 'tab_create.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Tab creation"))
        self.label.setStyleSheet(_translate("Form", "0"))
        self.label.setText(_translate("Form", "Give your new tab a name"))
