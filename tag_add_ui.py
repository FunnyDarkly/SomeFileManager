...
# Form implementation generated from reading ui file 'tag_add.ui'
#
...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        Form.setWindowTitle(_translate("Form", "Tag adding"))
        self.label.setStyleSheet(_translate("Form", "0"))
        self.label.setText(_translate("Form", "Add tag to tab from list"))
